...
and emits ONE low-confidence ``PaymentDraft`` so the email still flows to
the review queue. Everything it produces is meant to be corrected by a
human — that is the point of Phase 1.
"""
